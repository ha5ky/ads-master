<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"C:\phpStudy\PHPTutorial\WWW\adsweb\public/../application/index\view\public\index.html";i:1533785745;}*/ ?>
...
<html lang="en" class="demo-drawings no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/static/show/css/demo.css" />
		<link rel="stylesheet" type="text/css" href="/static/show/css/component.css" />
		<!--[if IE]>
	...
	<body>
		<div class="container">
			...
			<!-- <div class="codrops-top clearfix">
				<a class="codrops-icon codrops-icon-prev" href="http://tympanus.net/Development/BurstingGiftBox/"><span></span></a>
				<span class="right"><a class="codrops-icon codrops-icon-drop" href="http://tympanus.net/codrops/?p=18012"><span>Back to the Codrops Article</span></a></span>
			</div> -->
			<header class="codrops-header">
				<h1>Advertisement Master | 广告大师<span>为消费者提供最新最热的优惠资讯 | 为商家提供最快最高效的推广</span></h1>
			...
			<div id="main" class="main">
				<figure>
					<div class="drawings mac">
						<img class="illustration" src="/static/show/img/imac.png" alt="iMac Illustration" />
					...
					<figcaption>
						<h2>电脑端</h2>
						<p>广告大师电脑端, 为商家提供广告发放功能。商家自行编辑需发放广告内容及排版，提交后即可在用户端进行查看。</p>
					</figcaption>
				</figure>
				<figure>
					<div class="drawings ipad">
						<img class="illustration" src="/static/show/img/ipad.png" alt="iPad Illustration" />
					...
					<figcaption>
						<h2>移动平台</h2>
						<p>广告大师，为移动端全平台提供支持，用户可在任意一可联网移动端进行消息查看</p>
					</figcaption>
				</figure>
				<figure>
					<div class="drawings iphone">
						<img class="illustration" src="/static/show/img/iphone.png" alt="iPhone Illustration" />
					...
					<figcaption>
						<h2>广告大师</h2>
						<p>其中，手机为主要用户群体，用户可以在手机上查看广告，领取商家发放的红包，并为用户提供地理位置以及导航， 用户可以收藏喜欢的店家以及传单等等。</p>
					</figcaption>
				</figure>
			</div>
			<section class="related">
				<p>加入我们：</p>
				<div><a href="<?php echo url('leaflet/add'); ?>"><h4>成为商家</h4></a></div>
				<div><a href="#"><h4>联系我们</h4></a></div>
			</section>
		</div><!-- /container -->
		<script src="/static/show/js/classie.js"></script>
		<script src="/static/show/js/svganimations.js"></script>
	</body>
</html>