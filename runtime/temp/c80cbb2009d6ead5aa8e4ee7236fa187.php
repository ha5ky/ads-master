<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"C:\PHPTutorial\WWW\adsweb\public/../application/index\view\leaflet\add.html";i:1534330987;s:60:"C:\PHPTutorial\WWW\adsweb\application\index\view\layout.html";i:1533263254;s:67:"C:\PHPTutorial\WWW\adsweb\application\index\view\public\header.html";i:1534068558;s:67:"C:\PHPTutorial\WWW\adsweb\application\index\view\public\footer.html";i:1534002831;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>广告大师</title>
...
<body>
  ...
  <div id="content-header">
    <div id="breadcrumb"> 
      ...
      <a href="#" class="tip-bottom">广告添加</a> 
    </div>
    <h1>广告添加</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form action="#" method="get" class="form-horizontal">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="seller" class="span11" placeholder="店名" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">地址：</label>
                <div class="controls">
                  <input type="text" name="addr" class="span11" placeholder="地址" />
                </div>
              </div>
      ...
      <div class="span3">
        <div class="widget-box">
          ...
          <div class="widget-content"> 
            <img class="center-block img-responsive" src="/static/admin/img/top.png">
            <div id="pre" style="width: 347px;height: 500px;overflow: auto;">
            </div>
          </div>
        </div>
      </div>
      <div class="row-fluid">
        <div class="span5">
          <div class="widget-box">
            ...
            <div class="widget-content">
              <div class="control-group">
                <form action="<?php echo url('index/leaflet/add'); ?>" method="post" class="form-horizontal">
                  <script type="text/javascript" src="/static/admin/ue/ueditor.config.js"></script>
                  <script type="text/javascript" src="/static/admin/ue/ueditor.all.min.js"></script>
                  <textarea  type="text/plain"  id="editor" name="ads_content" style="height: 667px;"></textarea>
                  <script type="text/javascript">
                    var ue = UE.getEditor('editor');
                  </script>
                  <div class="control-group">
                    <label class="control-label">红包数：</label>
                    <div class="controls">
                      <input type="text" name="" class="span11" placeholder="number"  />
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <div class="input-append">
                        <input type="text" name="money" class="span11" placeholder="money" />
                        <span class="add-on">¥</span>
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">区域半径：</label>
                    <div class="controls">
                      <div class="input-append">
                        <input type="text" name="radius" class="span11" placeholder="" />
                        <span class="add-on">米</span>
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">传单简介：</label>
                    <div class="controls">
                  ...
                  <div class="center-block">
                    ...
                    <button id="prev" type="button" class="btn btn-info">预览</button>
                  </div>
                </form>
              </div>
            </div>
